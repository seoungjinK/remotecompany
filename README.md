GitHub README.md는 프로젝트의 얼굴입니다. 지금까지 우리가 정리했던 기술적 내용(GDI+, REST API, Polling, 트랜잭션 등)을 잘 녹여내면 아주 훌륭한 포트폴리오가 될 것입니다.

아래 내용을 복사해서 README.md 파일에 붙여넣기 하시면 됩니다. (필요한 경우 스크린샷 이미지 경로만 수정하세요.)
